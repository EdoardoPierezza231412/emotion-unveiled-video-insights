...
import { EmotionPrediction } from "@/lib/csv-utils";
    ...
    setTimeout(() => {
      ...
      const mockPredictions: EmotionPrediction[] = [
        ...
        },
        {
          id: uuidv4(),
          timestamp: new Date(),
          text: "This makes me feel somewhat disappointed.",
          emotion: "sadness",
          intensity: 60,
          source: "video"
        },
        {
          id: uuidv4(),
          timestamp: new Date(),
          text: "I don't have strong feelings about this situation.",
          emotion: "neutral",
          intensity: 75,
          source: "video"
        }
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container py-8">
        ...
        {!videoSource ? (
          ...
          <>
            <Tabs value={activeTab} onValueChange={value => setActiveTab(value as "preview" | "data")} className="mb-6">
              <TabsList>
            ...
            <TabsContent value="data" className="mt-0">
              <div className="grid gap-6">
                {/* CSV Preview */}
                <CSVPreview predictions={predictions} />
